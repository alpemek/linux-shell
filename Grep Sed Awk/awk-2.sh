...
# Your task is to identify whether each of the students 
# has passed or failed. A student is considered to have 
# passed if (s)he has a score 50 or more in each of the 
# three subjects.
